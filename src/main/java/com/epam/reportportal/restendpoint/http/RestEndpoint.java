...
public interface RestEndpoint {
	 ...
	 * @throws RestEndpointIOException In case of error
	 */
	<RS> Maybe<Response<RS>> post(String resource, MultiPartRequest request, Class<RS> clazz) throws RestEndpointIOException;
	 ...
	 * @throws RestEndpointIOException In case of error
	 */
	<RS> Maybe<Response<RS>> get(String resource, Map<String, String> parameters, Class<RS> clazz) throws RestEndpointIOException;
	 ...
	 * @throws RestEndpointIOException In case of error
	 */
	<RS> Maybe<RS> getFor(String resource, Map<String, String> parameters, Class<RS> clazz) throws RestEndpointIOException;
	 ...
	 * @throws RestEndpointIOException In case of error
	 */
	<RS> Maybe<Response<RS>> get(String resource, Map<String, String> parameters, Type type) throws RestEndpointIOException;
