...
public class JaxbSerializerTest {
	...
	public void testSerialize() throws SerializerException {
		...
		SmartAssert.assertHard(new String(result), CoreMatchers.is(TEST_STRING), "Incorrect serialization result");
	}
	...
	public void testDeserialize() throws SerializerException {
		...
		SmartAssert.assertHard(result, CoreMatchers.is(TEST_BEAN), "Incorrect deserialization result");
	}
	...
	public void testContentType() {
		...
		SmartAssert.assertSoft(serializer.canRead(MediaType.APPLICATION_XML_UTF_8, Object.class),
				...
				"Wrong content type handling - cannot read application/xml"
		);

		SmartAssert.assertSoft(serializer.canWrite(new DemoBean()),
				CoreMatchers.is(true),
				"Wrong content type handling. Cannot write test object"
		);
