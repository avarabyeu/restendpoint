...
public class RestEndpointsTest extends BaseRestEndointTest {
    ...
    @Test
    public void testDefault() throws ExecutionException, InterruptedException {
    ...
    public void testNoSerializer() throws ExecutionException, InterruptedException {
    ...
    @Test
    public void testBuilderHappy() throws ExecutionException, InterruptedException {
        RestEndpoint endpoint = RestEndpoints.create().withBaseUrl(HTTP_TEST_URK + server.getPort())
    ...
    @Test
    public void testBuilderBasicAuth() throws InterruptedException, ExecutionException {
        RestEndpoint endpoint = RestEndpoints.create().withBaseUrl(HTTP_TEST_URK + server.getPort())
